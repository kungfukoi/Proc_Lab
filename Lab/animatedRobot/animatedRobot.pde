...
final int ROBOT_X = 125;
final int ROBOT_Y = 100;

//The robot's midpoint and arm pivot points
final int MIDPOINT_X = 39; // x-cord 14 + bodywidth 50
...
void draw()
{
  ...
  //if the arm has moved past itls limit,
  // reverse direction and set with limits.
